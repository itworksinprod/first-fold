...
For each candidate supply a short rationale and an EXACT quote from a named evidenceId/sourceId supporting the actual change and relevance. Quotes are private review evidence, not text for publication. You may omit insufficient candidates. Use only supplied candidate IDs. Return schema-valid JSON.`;
