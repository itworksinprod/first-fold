...
test('workflow tests the new mode before credentials and grants neither delivery access nor new secrets', async () => {
  ...
  assert.equal((workflow.match(/\(inputs.mode == 'frozen-sentence-language' \|\| inputs.mode == 'frozen-definition-language'\) && secrets.FIRST_FOLD_FROZEN_BASELINE_B64/gu) ?? []).length, 2);
});
